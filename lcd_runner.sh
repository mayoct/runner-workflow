...
i2cset -y 1 $character $letters 67    # C
i2cset -y 1 $character $letters 105   # i
i2cset -y 1 $character $letters 114   # r
i2cset -y 1 $character $letters 99    # c
i2cset -y 1 $character $letters 108   # l
i2cset -y 1 $character $letters 101   # e
i2cset -y 1 $character $letters 67    # C
i2cset -y 1 $character $letters 73    # I 
sleep 1
...
i2cset -y 1 $character $letters 82    # R
i2cset -y 1 $character $letters 117   # u
i2cset -y 1 $character $letters 110   # n
i2cset -y 1 $character $letters 110   # n
i2cset -y 1 $character $letters 101   # e
i2cset -y 1 $character $letters 114   # r
i2cset -y 1 $character $letters 33    # !
